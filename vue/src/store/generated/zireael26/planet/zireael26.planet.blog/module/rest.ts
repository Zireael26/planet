...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/zireael26/planet/blog/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<BlogQueryParamsResponse, RpcStatus>({
      path: `/zireael26/planet/blog/params`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/zireael26/planet/blog/post
   */
  queryPostAll = (
    query?: {
    ...
    this.request<BlogQueryAllPostResponse, RpcStatus>({
      path: `/zireael26/planet/blog/post`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/zireael26/planet/blog/sent_post
   */
  querySentPostAll = (
    query?: {
      "pagination.key"?: string;
    ...
    this.request<BlogQueryAllSentPostResponse, RpcStatus>({
      path: `/zireael26/planet/blog/sent_post`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/zireael26/planet/blog/timedout_post
   */
  queryTimedoutPostAll = (
    ...
    this.request<BlogQueryAllTimedoutPostResponse, RpcStatus>({
      path: `/zireael26/planet/blog/timedout_post`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
